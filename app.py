...
def predict():
    if model is None:
        return render_template('templatesindex.html', prediction_text="Error: Model not loaded!")
    ...
    return render_template('templatesindex.html', prediction_text=f'Predicted House Price: ${prediction:,.2f}')
